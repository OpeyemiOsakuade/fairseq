    ...
    with progress_bar.build_progress_bar(args, itr) as t:
        for sample in t:
            ...
            for result in postprocess_results(
                ...
                count += 1
                dump_result(is_na_model, args, count, vocoder, args.use_sample_id_as_filename, args.add_count_to_filename, args.append_token_ids_to_filename,*result)#args.add_count_to_filename, args.append_token_ids_to_filename,
