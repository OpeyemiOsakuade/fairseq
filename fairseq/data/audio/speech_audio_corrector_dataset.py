...
class SpeechAudioCorrectorDatasetCreator(TextToSpeechDatasetCreator):
    ...
    def _from_list(
        ...
        # cls.word2speechreps_dir = "/disk/nfs/ostrom/s2324992/data/yoruba/wordspeechreps_100"
        # cls.word2speechreps_dir = "/disk/nfs/ostrom/s2324992/data/LJSpeech-1.1/word2speechreps"
        cls.word2speechreps_dir = "/home/s2324992/data/yoruba/wordspeechreps_500"
        ...
        if alignment_type == "mfa":
            ...
            alignments_dir = "/disk/nfs/ostrom/s2324992/data/yoruba/final_align/TextGrid"
            # alignments_dir = "/home/s2324992/data/LJSpeech-1.1/audio_data/LJSpeech-1.1/aligned"
            word2speechreps, ids2word_alignments = cls.get_word2speechreps(
                speechrep_file, alignments_dir, ids=ids, corpus="yoruba",
...
def get_num_clusters(quantized_dataset_filepath, possible_num_codes=(50,100,200,500)):
    code_set = set()
