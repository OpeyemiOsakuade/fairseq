...
class SpeechAudioCorrectorTask(TextToSpeechTask):
    ...
    def add_args(cls, parser):
        ...
        parser.add_argument("--quantized-speechreps-file", type=str, default="/disk/nfs/ostrom/s2324992/data/yoruba/manifests/yor_quantised500.txt",
        # parser.add_argument("--quantized-speechreps-file", type=str, default="/home/s2324992/data/LJSpeech-1.1/manifests/ljspeech_quantised_km100.txt",
