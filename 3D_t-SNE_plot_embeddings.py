...
embeddings = np.load('/disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/mandarin_frames/HF_no_syllables/w2v2_all_vectors/train_man_features_last_layer.npy', allow_pickle=True)
labels = np.load('/disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/mandarin_frames/HF_no_syllables/w2v2_all_vectors/train_man_plain_vowels.npy', allow_pickle=True)
...
fig = px.scatter_3d(
    ...
    labels={'color': 'Label'},
    title='3D t-SNE w2v2 Embeddings of Mandarin Vowels without tones'
)
fig.update_traces(marker=dict(size=3, opacity=0.8))

# Save the plot as an HTML file
fig.write_html('3D_tSNE_w2v2_Mandarin_Vowels_without_tones.html')
