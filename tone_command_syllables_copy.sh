#!/bin/bash
#SBATCH -o /home/%u/slogs/man_tone_l9_yor_%A.out
#SBATCH -e /home/%u/slogs/man_tone_l9_yor_%A.out
...
# python feature_syllable_ssl_extraction_mandarin.py \
#   --feature_type hubert \
#   --manifest_path /disk/ostrom/homedirs/s2324992/tonal_data/data/mandarin/manifest/train.tsv\
#   --out_features_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/mandarin_frames/HF/mean_syllables_plain_vowels/syllables_train_man_frames.npy \
#   --out_labels_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/yor_frames/HF/mean_syllables_plain_vowels/syllables_train_man_labels.npy \
#   --out_syllables_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/yor_frames/HF/mean_syllables_plain_vowels/syllables_train_man_syllables.npy \
#   --model_name facebook/hubert-base-ls960 \
#   --pooling_type mean \
#   --layer 9 \
#   --sample_pct 1 \
...
python feature_vowel_classifier_reps_lstm.py \
  --data_path /disk/ostrom/homedirs/s2324992/tonal_data/data/mandarin/models/mandarinHuBERT_9/for_tones_1000/updated_0.1_manhu_manl9c1000_tone_reps.json \
  --model_output_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/mandarin_frames/HF_no_syllables/discrete_features/models/manHutones_1000_lstm_model.pth
