#!/bin/bash
#SBATCH -o /home/%u/slogs/sylw2v2_l9_yor_%A.out
#SBATCH -e /home/%u/slogs/sylw2v2_l9_yor_%A.out
...
#   --feature_type hubert \
#   --manifest_path /disk/ostrom/homedirs/s2324992/tonal_data/data/yoruba_wav/yoruba/manifest/manifest/train_dev.tsv \
#   --out_features_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/yor_frames/HF_optimized/all_vectors/syllables_train_dev_yor_features.npy \
#   --out_labels_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/yor_frames/HF_optimized/all_vectors/syllables_train_dev_yor_labels.npy \
#   --out_syllables_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/yor_frames/HF_optimized/all_vectors/syllables_train_dev_yor_syllables.npy \
#   --model_name facebook/hubert-base-ls960 \
#   --sample_pct 1 \
#   --textgrid_dir /disk/ostrom/homedirs/s2324992/tonal_data/data/yoruba_wav/aligned \
#   --vowel_set a aH aL e eH eL eR eRH eRL i iH iL o oH oL oR oRH oRL u uH uL an anH anL en enH enL eRn eRnH eRnL in inH inL on onH onL oRn oRnH oRnL un unH unL \
...
#   --features_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/yor_frames/HF_optimized/all_vectors/syllables_train_dev_yor_features_layer_9.npy \
...
#   --model_output_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/yor_frames/HF_optimized/all_vectors/models/yor_lstm_vowels_with_tone_model_l9.pkl


# python feature_vowel_classifier_reps_lstm.py \
#   --data_path /disk/ostrom/homedirs/s2324992/tonal_data/data/mandarin/models/mandarinHuBERT_9/for_phones/0.1_manHUl9c200_phones_reps.json \
#   --model_output_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/mandarin_frames/HF_no_syllables/discrete_features/models/vowel_no_tone_lstm_model.pth

# python feature_vowel_classifier_LR.py \
#   --features_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/mandarin_frames/HF_no_syllables/mean_vectors/mandarinhu_train_man_features.npy \
#   --labels_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/mandarin_frames/HF_no_syllables/mean_vectors/mandarinhu_train_man_vowels.npy \
#   --model_output_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/mandarin_frames/HF_no_syllables/mean_vectors/models/mandarinhu_model_vowels_with_tone.pkl
...
#   --labels_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/yor_frames/HF_optimized/mean_vectors/syllables_train_dev_yor_vowels.npy \
#   --model_output_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/yor_frames/HF_optimized/mean_vectors/models/yor_xlsr_model_vowels_with_tone.pkl


# python feature_syllable_ssl_extraction_new.py \
#   --feature_type w2v2 \
#   --manifest_path /disk/ostrom/homedirs/s2324992/analysis/manifest/all.tsv \
#   --out_features_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/yor_frames/HF_optimized/w2v2_all_vectors/syllables_train_dev_yor_features.npy \
#   --out_labels_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/yor_frames/HF_optimized/w2v2_all_vectors/syllables_train_dev_yor_labels.npy \
#   --out_syllables_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/yor_frames/HF_optimized/w2v2_all_vectors/syllables_train_dev_yor_syllables.npy \
#   --model_name facebook/wav2vec2-base-960h \
#   --sample_pct 1 \
#   --textgrid_dir /disk/ostrom/homedirs/s2324992/analysis/TextGrid \
#   --vowel_set a aH aL e eH eL eR eRH eRL i iH iL o oH oL oR oRH oRL u uH uL an anH anL en enH enL eRn eRnH eRnL in inH inL on onH onL oRn oRnH oRnL un unH unL \
