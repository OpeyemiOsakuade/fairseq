...
#   --feature_type w2v2 \
#   --manifest_path /disk/ostrom/homedirs/s2324992/tonal_data/data/yoruba_wav/yoruba/manifest/manifest/train_dev.tsv \
#   --out_features_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/yor_frames/HF_optimized/all_vectors/xlsr_syllables_train_dev_yor_features.npy \
#   --out_labels_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/yor_frames/HF_optimized/all_vectors/xlsr_syllables_train_dev_yor_labels.npy \
#   --out_syllables_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/yor_frames/HF_optimized/all_vectors/xlsr_syllables_train_dev_yor_syllables.npy \
...
#   --labels_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/yor_frames/HF_optimized/all_vectors/syllables_train_dev_yor_tones.npy\
#   --model_output_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/yor_frames/HF_optimized/all_vectors/models/yor_lstm_tone_model_l9.pkl

# python feature_vowel_classifier_reps_lstm.py \
#   --data_path /disk/ostrom/homedirs/s2324992/tonal_data/data/yoruba_wav/models/xlsr_9/for_tones/0.1_yorxlsrl9c200_tones_reps.json \
#   --model_output_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/yor_frames/HF_optimized/discretized_sequence/models/tone_lstm_model.pth

# python feature_syllable_ssl_extraction_new_yor_pooling.py \
#   --feature_type w2v2 \
#   --manifest_path /disk/ostrom/homedirs/s2324992/tonal_data/data/yoruba_wav/yoruba/manifest/manifest/train_dev.tsv \
#   --out_features_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/yor_frames/HF_optimized/mean_vectors/syllables_train_dev_yor_frames.npy \
#   --out_labels_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/yor_frames/HF_optimized/mean_vectors/syllables_train_dev_yor_labels.npy \
#   --out_syllables_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/yor_frames/HF_optimized/mean_vectors/syllables_train_dev_yor_syllables.npy \
#   --model_name facebook/wav2vec2-xls-r-300m \
#   --pooling_type mean \
#   --layer 9 \
#   --sample_pct 1 \
...
#   --labels_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/mandarin_frames/HF_no_syllables/mean_vectors/mandarinhu_train_man_tones.npy \
#   --model_output_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/mandarin_frames/HF_no_syllables/mean_vectors/models/mandarinhu_model_tone.pkl
...
python feature_vowel_classifier_LR.py \
  ...
  --labels_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/yor_frames/HF_optimized/mean_vectors/syllables_train_dev_yor_tones.npy \
  --model_output_path /disk/ostrom/homedirs/s2324992/tonal_data/tone_quantization/yor_frames/HF_optimized/mean_vectors/models/yor_xlsr_model_tone.pkl
